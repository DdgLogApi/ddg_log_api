...
define('ADT_FREE_CARRIAGE_LEAVE',30);  //免运费金额
define('ADT_AVALIABLE_DISTANCE',3000);  //配送范围，单位米
...
define('ATTACH_COMPLAIN','shop/complain');
 ...
 */
//叮大哥 未支付关闭订单 单位小时
define('PTB_ORDER_AUTO_CANCEL_HOUR', 2);
//叮大哥 发货后确认收货时间 单位天
define('PTB_ORDER_AUTO_RECEIVE_DAY', 1);
//叮大哥活动 发货后确认收货时间 单位天
define('PTB_ACT_ORDER_AUTO_RECEIVE_DAY', 15);
//叮大哥活动 拼团快递签收后自动确认收货时间 单位天
define('PTB_ACT_ORDER_EXPRESS_SIGN_AUTO_RECEIVE_DAY', 3);
//未支付关闭订单 单位天
 ...
 * 返利比率设定 
 */
define('REBATE_BUY_USER', 30);  //买家返佣比率
define('REBATE_FIREST_INVITER', 10);   //一级邀请人返佣比率
define('REBATE_SECOND_INVITER', 10);   // 二级邀请人返佣比率
define('REBATE_EXTEND_INVITER', 10);   // 社区推广商返佣比率
//define('REBATE_PLATFORM', 6);     //平台返佣比率
...
define('REBATE_PROVINCE_AGENCY', 6);      //新模式省级代理返佣比率(社区推广商后)


define('UPGRADE_FIRST_DISTRIBUTION', 2888); //二级分销商晋升一级分销商分销金额
...
// 商品状态
define('DEF_STORAGE_ALARM', 10);  // 商品默认库存预警


/*平台的客服电话*/
define('SERVER_PHOHE','0512-67631895');
